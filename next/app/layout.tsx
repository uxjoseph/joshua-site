...
export const metadata: Metadata = {
  ...
  // 파비콘은 app/icon.png·favicon.ico·apple-icon.png 파일 컨벤션이 자동 처리한다.
};
...
// 구글이 검색 결과의 사이트 이름을 판단할 때 참조하는 스키마.
const websiteJsonLd = {
  '@context': 'https://schema.org',
  '@type': 'WebSite',
  name: '조슈아앤컴퍼니',
  alternateName: ['JOSHUA', 'Joshua & Company', '조슈아 앤 컴퍼니'],
  url: SITE.url,
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="ko">
      <head>
        {/* Google Tag Manager — 인디코 SEO/애널리틱스 연동용 (2026-08-26) */}
        <Script
          id="gtm-loader"
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
      ...
      <body>
        {/* Google Tag Manager (noscript) — <body> 직후 삽입 */}
        <noscript>
          <iframe

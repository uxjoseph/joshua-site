...
export const EDUCATION: Education[] = [
  { year: '2026', client: '카카오뱅크', title: "임원 대상 'AI Agent 시대' 특강", description: '카카오뱅크 임원진을 대상으로 AI 에이전트가 가져올 비즈니스 패러다임 전환과 금융 서비스의 미래를 다뤘습니다. 의사결정자가 반드시 알아야 할 AI 도입 전략과 실행 우선순위를 제시했습니다.', image: '/portfolio/education/IMG_0340.webp' },
  ...
  { year: '2025', client: '월급쟁이부자들', title: '멀티에이전트 & Claude Co-Work 자동화 사례', description: '멀티에이전트 시스템과 Claude Co-Work을 활용한 실제 자동화 사례를 공유하고, 콘텐츠·운영 업무에 즉시 적용 가능한 워크플로우를 함께 설계했습니다.', image: '/portfolio/education/IMG_0723.webp' },
...
export const TEAM = [
  ...
  { name: '이안', role: '개발 스태프', description: '프로덕트 구현과 운영을 담당하며, 요구사항을 빠르고 견고한 코드로 옮깁니다.', image: '/team-ian.webp' },
] as const;
